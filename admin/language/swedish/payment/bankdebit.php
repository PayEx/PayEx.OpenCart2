...
$_['heading_title'] = 'PayEx Bank Debit';
$_['text_payment'] = 'Payment';
$_['text_bankdebit']   = '<a href="http://payex.com/" target="_blank"><img src="view/image/payment/payex.gif" alt="PayEx Bank Debit" title="PayEx Bank Debit" style="border: 1px solid #eee;" /></a>';
$_['text_success'] = 'Success: PayEx Bank Debit settings saved.';
$_['text_settings'] = 'Settings';
$_['text_transactions'] = 'Transactions';
$_['text_pending_transactions'] = 'Pending Transactions';
$_['text_account_number'] = 'Account number';
$_['text_encryption_key'] = 'Encryption key';
$_['text_mode'] = 'Mode';
$_['text_banks'] = 'Banks';
